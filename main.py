...
<main>
    ...
    <div class="container">
                ...
                <div class="col-4">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <button type="button" class="w-100 btn btn-success btnbtn-outline-primary">Купить</button>
                        </div>
                    </div>
                </div>
                <div class="col-3"></div>
        ...
        <div class="row text-center">
            ...
            <div class="col-4">
                <p>
                    <button class="w-100 btn btn-lg btn-info text-white"
...
"""
    def do_GET(self):
        ...
        self.wfile.write(bytes(self.__get_html_page(), encoding='utf-8')) # Тело ответа
